...
class DonatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donate" do
    assert_difference('Donate.count') do
      post donates_url, params: { donate: { donate: @donate.donate, project_id: @donate.project_id, user_id: @donate.user_id } }
    end
  ...
  test "should update donate" do
    patch donate_url(@donate), params: { donate: { donate: @donate.donate, project_id: @donate.project_id, user_id: @donate.user_id } }
